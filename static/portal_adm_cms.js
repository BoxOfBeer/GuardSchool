...
function formatPipeLines(items) {
  ...
  return items.map((x) => `${x.label}|${x.href}`).join("\n");
}
...
function mountForm() {
  ...
  root.innerHTML = `
    <div class="toolbar actions-row" style="margin-top:8px">
    ...
    <h3 style="color:#fff;margin:18px 0 8px;font-size:1rem">Мета / SEO</h3>
    ...
    <h3 style="color:#fff;margin:18px 0 8px;font-size:1rem">Герой</h3>
    <div class="toolbar inputs-row">
    ...
    <textarea class="portal-field" id="cms-hero-secondary" rows="3" style="width:100%;font-family:ui-monospace,monospace;font-size:13px"></textarea>

    <h3 style="color:#fff;margin:18px 0 8px;font-size:1rem">Блок «экосистема»</h3>
    ...
    <h3 style="color:#fff;margin:18px 0 8px;font-size:1rem">Приложения</h3>
    ...
    <h3 style="color:#fff;margin:18px 0 8px;font-size:1rem">Демо</h3>
    <div class="toolbar inputs-row">
    ...
    <div class="toolbar inputs-row">
      <div class="grow"><label class="portal-label">Кнопка демо — подпись</label><input class="portal-field" id="cms-demo-act-label" /></div>
      <div class="grow"><label class="portal-label">Кнопка демо — href</label><input class="portal-field" id="cms-demo-act-href" placeholder="/try-demo" /></div>
    </div>

    <h3 style="color:#fff;margin:18px 0 8px;font-size:1rem">Боковая колонка</h3>
    ...
    <textarea class="portal-field" id="cms-aside-items" rows="4" style="width:100%;font-family:ui-monospace,monospace;font-size:13px"></textarea>

    <h3 style="color:#fff;margin:18px 0 8px;font-size:1rem">Подвал</h3>
